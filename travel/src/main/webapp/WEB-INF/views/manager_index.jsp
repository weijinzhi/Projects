...
<script type="text/javascript"
	src="${path }/bootstrap-3.3.7-dist/js/index.js"></script>
...
<body class="">
			...
			<ul class="nav metismenu" id="side-menu">
				<li class="nav-header">
					...
					<span><img alt="image" class="img-circle"
								src="${path }/bootstrap-3.3.7-dist/img/profile_small.jpg" /></span>
				...
				<li><a onclick=""><i class="fa fa-cog"></i> <span
						class="nav-label">用户管理</span> <span class="fa arrow"></span> </a>
					<ul class="nav nav-second-level collapse">
						<li><a onclick="getPage('${path}/guide/goGuide','导游')"> <i
								class="fa fa-user"></i> <span class="nav-label">导游</span>
						</a></li>
				...
				<li><a onclick="getPage('${path}/cluster/goCluster','导游')"><i
						class="fa fa-cog"></i> <span class="nav-label">群组管理</span></a></li>
						
				<li><a onclick=""><i class="fa fa-cog"></i> <span
						class="nav-label">地图管理</span> <span class="fa arrow"></span> </a>
					<ul class="nav nav-second-level collapse">
						<li><a onclick="getPage('${path}/guide/goGuide','导游')"> <i
								class="fa fa-user"></i> <span class="nav-label">添加路网</span>
						</a></li>
						<li><a onclick="getPage('${path}/visitor/goVisitor','游客')">
								<i class="fa fa-user"></i> <span class="nav-label">游客</span>
						</a></li>
	...
	<!-- 模态框（Modal） -->
	<!-- 修改 -->
	<div id="passDlg" class="modal fade" tabindex="-1" role="dialog"
						...
						<div class="form-group">
							...
							<div class="col-md-3 ">
								<input type="password" id="oldPass" name="oldPass"
									class="form-control form-control-static" placeholder="请输入原始密码">
								<input type="hidden" id="pass" value="${password }"
									name="password"> <input type="hidden" id="uid"
									value="${id }" name="id">
							</div>
						</div>
